...
function AuthShell({
  ...
  return (
    <div className="relative min-h-svh overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(37,99,235,0.12),_transparent_35%),linear-gradient(180deg,_rgba(248,250,252,1)_0%,_rgba(255,255,255,1)_45%,_rgba(241,245,249,0.7)_100%)]">
      <div className="absolute inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_top,_rgba(15,23,42,0.08),_transparent_60%)]" />
      <div className="relative mx-auto flex min-h-svh w-full max-w-7xl flex-col px-6 py-6 lg:px-8">

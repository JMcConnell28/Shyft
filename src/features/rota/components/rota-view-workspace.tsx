...
import RotaMobileAppView from "@/features/rota/components/rota-mobile-app-view"
...
function RotaViewWorkspace({ boardData }: { boardData: WorkspaceBoardData }) {
  return (
    <RotaWorkspaceProvider boardData={boardData}>
      <RotaMobileAppView />
      <div className="hidden min-h-0 flex-1 flex-col gap-2 overflow-hidden p-2 md:flex">
        <RotaViewToolbar />

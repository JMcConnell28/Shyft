...
] satisfies Array<Omit<WorkspaceEmployee, "compensation" | "groupColor">>)
...
function withGroupColors(
  employees: Array<Omit<WorkspaceEmployee, "compensation" | "groupColor">>
) {
...
const placeholderAssignments: WorkspaceAssignment[] = [
  ...
  ...createAssignments("shift-mon-bar-close", [
    "emp-owen",
    "emp-layla",
    "emp-finn",
  ]),
  ...createAssignments("shift-mon-floor-close", [
    "emp-noah",
    "emp-scarlett",
    "emp-mia",
  ]),
  ...
  ...createAssignments("shift-tue-bar-close", [
    "emp-jack",
    "emp-harvey",
    "emp-rio",
  ]),
  ...createAssignments("shift-tue-floor-close", [
    "emp-amber",
    "emp-roman",
    "emp-lila",
  ]),
  ...createAssignments("shift-tue-kitchen-close", [
    "emp-kai",
    "emp-isla",
    "emp-remy",
  ]),
  ...
  ...createAssignments("shift-wed-bar-close", [
    "emp-alexander",
    "emp-layla",
    "emp-finn",
  ]),
  ...createAssignments("shift-wed-floor-close", [
    "emp-annabelle",
    "emp-theodore",
    "emp-ava",
  ]),
  ...createAssignments("shift-wed-kitchen-close", [
    "emp-sebastian",
    "emp-mateo",
  ]),

  ...createAssignments("shift-thu-bar-open", ["emp-ivy", "emp-rio"]),
  ...createAssignments("shift-thu-floor-lunch", [
    "emp-bo",
    "emp-leo",
    "emp-lila",
  ]),
  ...createAssignments("shift-thu-kitchen-prep", ["emp-aj", "emp-nina"]),
  ...createAssignments("shift-thu-bar-close", [
    "emp-jack",
    "emp-harvey",
    "emp-evangeline",
  ]),
  ...createAssignments("shift-thu-floor-close", [
    "emp-noah",
    "emp-amber",
    "emp-roman",
  ]),
  ...createAssignments("shift-thu-kitchen-close", [
    "emp-hugo",
    "emp-mohammed",
    "emp-kai",
  ]),

  ...createAssignments("shift-fri-bar-open", [
    "emp-zoe",
    "emp-ruby",
    "emp-imogen",
  ]),
  ...createAssignments("shift-fri-floor-lunch", [
    "emp-millie",
    "emp-sadie",
    "emp-ava",
  ]),
  ...createAssignments("shift-fri-kitchen-prep", [
    "emp-ella",
    "emp-luca",
    "emp-nina",
  ]),
  ...createAssignments("shift-fri-bar-mid", [
    "emp-owen",
    "emp-finn",
    "emp-rio",
  ]),
  ...createAssignments("shift-fri-floor-evening", [
    "emp-scarlett",
    "emp-amber",
    "emp-lila",
  ]),
  ...createAssignments("shift-fri-kitchen-close", [
    "emp-hugo",
    "emp-isla",
    "emp-remy",
  ]),
  ...createAssignments("shift-fri-bar-close", [
    "emp-alexander",
    "emp-harvey",
    "emp-evangeline",
  ]),
  ...createAssignments("shift-fri-floor-close", [
    "emp-annabelle",
    "emp-theodore",
    "emp-roman",
  ]),

  ...createAssignments("shift-sat-bar-open", [
    "emp-ivy",
    "emp-jack",
    "emp-zoe",
  ]),
  ...
  ...createAssignments("shift-sat-kitchen-prep", [
    "emp-aj",
    "emp-ella",
    "emp-luca",
  ]),
  ...
  ...createAssignments("shift-sun-kitchen-close", [
    "emp-mohammed",
    "emp-christopher",
  ]),
]

...
export const Route = createFileRoute("/_authed/_verified/o/$orgSlug/rota/")({
...
function RotaWorkspaceRoute() {
  ...
  const activeOrganization = viewer.activeOrganization

  if (!activeOrganization) {
    throw new Error("An active organization is required for rota routes.")
  }
